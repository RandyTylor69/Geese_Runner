...
/**
 * This class represents a pointed-top Hexagon cell used to make up a map.
...
public class Hexagon extends CellComponent {
	...
	public void setType(CellType type) {
		...
		isGrass = (type == CellType.GRASS);
		isSnow = (type == CellType.SNOW);
		isGoose = (type == CellType.GOOSE);
		isBook = (type == CellType.BOOK);
	}
	...
	public boolean isGrassCell() {
		return this.isGrass;
	}
	
	public boolean isSnowCell() {
		return this.isSnow;
	}
	
	public boolean isGooseCell() {
		return this.isGoose;
	}
	
	public boolean isBookCell() {
		return this.isBook;
	}
